const PRESETS = {
	...
	allub: {
		columns: [
			...
			{
				label: "Speedrun to 100 Points",
				id: "1eljby7eGGqhvvfpIpoeRvTBfg6DQ7_QzHEJl4Sz_sq8",
				sheetName: "Speedrun to 100 Points",
				nameCol: 1,
				scoreCol: 2,
			},
			{
				label: "Speedrun to 50 Points",
				id: "1eljby7eGGqhvvfpIpoeRvTBfg6DQ7_QzHEJl4Sz_sq8",
				sheetName: "Speedrun to 50 Points",
				nameCol: 1,
				scoreCol: 2,
			},
			{
			...
			},
			{
				label: "Android Score",
				id: "1eljby7eGGqhvvfpIpoeRvTBfg6DQ7_QzHEJl4Sz_sq8",
				sheetName: "Android Score",
				nameCol: 1,
				scoreCol: 2,
			},
			{
				label: "Score + Missed Points",
				id: "1eljby7eGGqhvvfpIpoeRvTBfg6DQ7_QzHEJl4Sz_sq8",
				sheetName: "Score + Missed Points",
				nameCol: 1,
				scoreCol: 2,
			},
			{
				...
				id: "1eljby7eGGqhvvfpIpoeRvTBfg6DQ7_QzHEJl4Sz_sq8",
				sheetName: "Points Per Second",
				nameCol: 1,
				scoreCol: 2,
			},
			{
				label: "Glitched Points",
				id: "1eljby7eGGqhvvfpIpoeRvTBfg6DQ7_QzHEJl4Sz_sq8",
				sheetName: "Glitched Points",
				nameCol: 1,
				scoreCol: 2,
			},
			{
	...
	allplus: {
		columns: [
			...
			{
				label: "Set Seed Score",
				id: "1Ogd5Cql3j6lS5r0aE99MDuY7GkxRhg-5onqlmwdoB00",
				sheetName: "Set Seed Score",
				nameCol: 1,
				scoreCol: 2,
			},
			{
			...
			{
				label: "Set Seed Speedrun to 50 Points",
				id: "1Ogd5Cql3j6lS5r0aE99MDuY7GkxRhg-5onqlmwdoB00",
				sheetName: "Set Seed Speedrun to 50 Points",
				nameCol: 1,
				scoreCol: 2,
			},
			{
				label: "Set Seed Speedrun to 100 Points",
				id: "1Ogd5Cql3j6lS5r0aE99MDuY7GkxRhg-5onqlmwdoB00",
				sheetName: "Set Seed Speedrun to 100 Points",
				nameCol: 1,
				scoreCol: 2,
			},
			{
